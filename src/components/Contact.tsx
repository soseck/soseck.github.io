...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-gray-700">ndeye.sokhna.seck@example.com</p>
                </div>
              </div>
      ...
      <footer className="mt-20 py-6 bg-gray-800 text-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p>© 2025 Ndeye Sokhna SECK. All rights reserved.</p>
        </div>
      </footer>
    </section>
  );
